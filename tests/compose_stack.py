...
ENV_FILE = ROOT / ".env"
TEST_ENV_CONTENT = """\
BEEBHAI_APP_NAME=BeemBhai
BEEBHAI_ENVIRONMENT=test
BEEBHAI_APP_VERSION=0.1.0
BEEBHAI_SECRET_KEY=test-secret-key
BEEBHAI_PUBLIC_BASE_URL={base_url}
